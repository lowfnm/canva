...
const ApplicationIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      viewBox="0 0 32 32"
    ...
    >
      <g clipPath="url(#_70268267__a)">
        ...
        ></path>
        <path d="M17.344 21.5c0-.345.28-.625.625-.625h7.25a.625.625 0 0 1 0 1.25h-7.25a.625.625 0 0 1-.625-.625Z"></path>
        <path d="M21.594 17.25c.345 0 .625.28.625.625v7.25a.625.625 0 0 1-1.25 0v-7.25c0-.345.28-.625.625-.625Z"></path>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
